<template>
  <UiGo
    ...
    class="
      ...
      before:absolute before:inset-0 before:-z-1 before:scale-0 before:rounded
      before:bg-yellow before:transition before:duration-1000
      before:content-['_']
      hover:before:scale-100 hover:before:rotate-360
    "
