...
export const MODE_LINK = 'MODE'

export const themeToggle: BallEntry = {
  label: 'Toggle Theme',
...
export const links: BallEntry[] = [
  ...
  */
  ...
  {
    icon: 'M0.17-2.36c-0.98-1.91-3.65-5.46-6.13-7.21C-8.34-11.25-9.25-10.96-9.84-10.69-10.53-10.38-10.66-9.32-10.66-8.7c0 0.62 0.34 5.1 0.57 5.84 0.74 2.47 3.35 3.3 5.76 3.04 0.12-0.02 0.25-0.04 0.37-0.05-0.12 0.02-0.25 0.04-0.37 0.05-3.53 0.52-6.67 1.81-2.56 6.39 4.52 4.68 6.2-1 7.06-3.89 0.86 2.88 1.85 8.37 6.98 3.89 3.85-3.89 1.06-5.86-2.47-6.39a7.89 7.89 0 0 1-0.38-0.05c0.13 0.02 0.25 0.03 0.38 0.05 2.41 0.27 5.02-0.57 5.76-3.04 0.22-0.75 0.56-5.22 0.56-5.84 0-0.62-0.13-1.68-0.81-1.99-0.59-0.27-1.5-0.56-3.88 1.12C3.82-7.82 1.15-4.26 0.17-2.36Z',
    link: 'https://bsky.app/profile/stillh.art',
    label: 'Bluesky',
  },
  themeToggle,
]
