...
const links = [
  ...
  */
  ...
  {
    label: 'GGJ',
    link: 'https://v3.globalgamejam.org/users/arc',
    icon: 'M-6.4,8.2c-.7.4-1.3.8-1.8,1.3,1.4,1.2,3,2.1,4.7,2.6-1.2-1.1-2.2-2.4-2.8-4h0ZM-.4,12.7v-6.2c-1.8,0-3.6.5-5.2,1.3,1.2,2.8,3.1,4.7,5.2,4.9H-.4ZM2.8-1.6h.9v.9h-.9v-.9ZM-8.2-9.2c.6.5,1.2,1,1.8,1.3.6-1.5,1.6-2.9,2.8-4-1.7.5-3.3,1.4-4.7,2.6h0ZM-3.1,1.1h.3L-1.5.2c0,0,.2,0,.2,0H1.4c0,0,.2,0,.2,0l1.2.8h.3c.8,0,1.5-.4,1.9-1.1s.4-1.5,0-2.2c-.4-.7-1.1-1.1-1.9-1.1H-3.1c-.8,0-1.5.4-1.9,1.1-.4.7-.4,1.5,0,2.2s1.1,1.1,1.9,1.1h0ZM1.9-1.6h.9v-.9h.9v.9h.9v.9h-.9V.2h-.9v-.9h-.9v-.9ZM-.4-2.5h.9v.9H-.4v-.9ZM-4.4-1.6h.9v-.9h.9v.9h.9v.9h-.9V.2h-.9v-.9h-.9v-.9ZM-8.9,9c.7-.6,1.4-1.1,2.1-1.6-.8-2.2-1.2-4.5-1.3-6.8h-4.5c.1,3.1,1.4,6.1,3.6,8.3h0ZM-.4-12.4c-2.1.2-4,2.1-5.2,4.9h0c1.6.8,3.4,1.3,5.2,1.3v-6.2ZM-8-.3c0-2.3.5-4.6,1.3-6.8-.8-.5-1.5-1-2.1-1.6-2.2,2.2-3.5,5.2-3.6,8.3h4.5ZM.5-12.4v6.2c1.8,0,3.6-.5,5.2-1.3-1.2-2.8-3.1-4.7-5.2-4.9h0ZM3.1,2.6l1,1.6h0c.1.2.4.4.7.4.3,0,.6,0,.8-.2.2-.2.3-.5.3-.7l-.2-2.8c-.6.7-1.5,1.1-2.4,1.1h-.4c0,0-.2,0-.2,0l-1.2-.8H-1.1l-1.2.8c0,0-.2,0-.2,0h-.4c-.9,0-1.8-.4-2.4-1.1l-.2,2.8c0,.3,0,.5.3.7.2.2.5.3.8.2.3,0,.5-.2.7-.4l1-1.6h0c.2-.4.7-.6,1.1-.6H2h0c.5,0,.9.2,1.1.6h0ZM6.1,7c.8-2.2,1.2-4.5,1.1-6.8,0-2.3-.4-4.6-1.1-6.8-1.9.9-3.9,1.4-6,1.4-2.1,0-4.2-.5-6-1.4-.8,2.2-1.2,4.5-1.1,6.8,0,2.3.4,4.6,1.1,6.8,1.9-.9,3.9-1.4,6-1.4s4.2.5,6,1.4ZM-2.2,3.1l-1,1.6h0c-.3.5-.9.9-1.6.9-.5,0-1-.2-1.3-.6-.3-.4-.5-.9-.5-1.4l.3-4.8c0-.8.3-1.6.9-2.2.6-.6,1.4-.9,2.2-.9H3.2c.8,0,1.6.3,2.2.9.6.6.9,1.4.9,2.2l.3,4.8c0,.5-.2,1.1-.6,1.5-.4.4-.9.6-1.5.5-.5,0-1-.4-1.3-.8l-1-1.6h0c0-.1-.2-.2-.4-.2H-1.8c-.2,0-.3,0-.4.2h0ZM8.4-9.2c-1.4-1.2-3-2.1-4.7-2.6,1.2,1.1,2.2,2.4,2.8,4,.7-.4,1.3-.8,1.8-1.3h0ZM.5,6.5v6.2c2.1-.2,4-2.1,5.2-4.9-1.6-.8-3.4-1.3-5.2-1.3h0ZM6.5,8.2c-.6,1.5-1.6,2.9-2.8,4,1.7-.5,3.3-1.4,4.7-2.6-.6-.5-1.2-1-1.8-1.3h0ZM8.1.6c0,2.3-.5,4.6-1.3,6.8.8.5,1.5,1,2.1,1.6,2.2-2.2,3.5-5.2,3.6-8.3h-4.5ZM9-8.6c-.7.6-1.4,1.1-2.1,1.6.8,2.2,1.2,4.5,1.3,6.8h4.5c-.1-3.1-1.4-6.1-3.6-8.3h0Z',
  },
  {
...
function getPermissionFunction() {
  const DeviceMotion = window.DeviceMotionEvent as any as DeviceMotionEvent & { requestPermission?: () => Promise<string> }
...
function onInteract(event: MouseEvent | TouchEvent, object: any) {
  ...
  const newTab = (event?.ctrlKey || event?.which === 2) || object.userData.link.startsWith('http')
  if (newTab || object.userData.link.startsWith('mailto')) {
