<template>
  <div class="head">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 57.47 30.9" id="name">
      <g>
        <path class="e2dd048c-46d6-4119-8048-f8958d2b68d6"
        ...
        <path class="f5edc65b-ca46-4752-bc2f-7026f8a9a307"
    ...
    <div class="constrain">
      <div class="row">
        <div class="col col-lg-11 intro">
          <input class="darkmode-checkbox" id="darkMode" type="checkbox" v-model="$root.darkmode"
            @change="$root.$emit('darkmode', $root.darkmode)" />
          <label for="darkMode" :title="$root.darkmode
